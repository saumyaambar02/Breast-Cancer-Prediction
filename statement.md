...
determine whether the tumor is malignant or benign. However, this process can be time consuming as well as not 
so accurate as the main challenges to classify the tumor into benign or malignant. The report may vary from one doctor to another.So, to minimize time 
